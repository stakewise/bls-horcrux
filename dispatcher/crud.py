...
def get_shares(db: Session, public_key_hash: str):
    return db.query(models.Share).filter(models.Share.recipient_rsa_public_key_hash == public_key_hash).all()


def get_share(db: Session, sender_rsa_public_key_hash: str, recipient_rsa_public_key_hash: str):
